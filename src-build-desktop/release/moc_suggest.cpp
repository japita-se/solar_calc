/****************************************************************************
** Meta object code from reading C++ file 'suggest.h'
**
** Created: Mon 25. Oct 20:56:22 2010
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.0)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../../src/suggest.h"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'suggest.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Suggest[] = {
    "Suggest\0\0compute()\0updateSpin()\0"
};

const QMetaObject Suggest::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Suggest,
      qt_meta_data_Suggest, 0 }
};
...
void *Suggest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Suggest"))
        return static_cast< Ui::Suggest*>(const_cast< Suggest*>(this));
